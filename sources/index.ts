...
// @ts-ignore
import { createProblemDetailsFromDiscriminatorValue, createSourceCredentialIssueResponseFromDiscriminatorValue, serializeSourceCredentialIssueResponse, serializeSourceRequest, type ProblemDetails, type SourceCredentialIssueResponse, type SourceRequest } from '../models/index.js';
// @ts-ignore
...
export interface SourcesRequestBuilder extends BaseRequestBuilder<SourcesRequestBuilder> {
     ...
     */
     post(body: SourceRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SourceCredentialIssueResponse | undefined>;
    /**
     * Creates a lead source for the current organization, storing intake credentials and routing context for captured external leads.
     * @param body Defines the fields clients can send when working with lead source.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
