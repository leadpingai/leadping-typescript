...
// @ts-ignore
import { createOrganizationApiKeyListResponseFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, serializeOrganizationApiKeyListResponse, serializeRequestDataOptions, type OrganizationApiKeyListResponse, type ProblemDetails, type RequestDataOptions } from '../../../models/index.js';
// @ts-ignore
...
export const MyRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createOrganizationApiKeyListResponseFromDiscriminatorValue,
