...
// @ts-ignore
import { createOrganizationResponseFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, serializeOrganizationRequest, serializeOrganizationResponse, type OrganizationRequest, type OrganizationResponse, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
...
export interface MeRequestBuilder extends BaseRequestBuilder<MeRequestBuilder> {
     ...
     * @returns {RequestInformation}
     */
     toPutRequestInformation(body: OrganizationRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const MeRequestBuilderUriTemplate = "{+baseurl}/organizations/me";
/**
...
export const MeRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    post: {
        ...
        requestBodySerializer: serializeOrganizationRequest,
