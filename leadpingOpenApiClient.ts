...
// @ts-ignore
import { A2aRequestBuilderRequestsMetadata, type A2aRequestBuilder } from './a2a/index.js';
// @ts-ignore
...
export const LeadpingOpenApiClientNavigationMetadata: Record<Exclude<keyof LeadpingOpenApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    a2a: {
        requestsMetadata: A2aRequestBuilderRequestsMetadata,
    },
    analytics: {
