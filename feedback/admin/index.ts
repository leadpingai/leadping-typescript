...
// @ts-ignore
import { createPagedResultOfFeedbackResponseFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, type PagedResultOfFeedbackResponse, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
